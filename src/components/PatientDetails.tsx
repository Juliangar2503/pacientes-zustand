  ...
  return (
    <div className="mx-5 my-10 px-5 py-10 bg-white shadow-md rounded-xl">
        ...
        <div className="flex justify-between mt-10 ">
            <button
                type="button"
                className="py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white fonst-bold uppercase rounded-lg"
                onClick={() => getPatientById(patients.id)}
            >Editar</button>
            <button
                type="button"
                className="ml-3 py-2 px-10 bg-red-600 hover:bg-red-700 text-white fonst-bold uppercase rounded-lg"
